...
export default function Sidebar() {
	...
	return (
		<section>
			<div
				className={`w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-white border-r z-30 ${
					isOpen ? "" : "hidden"
				}`}
			...
			>
				<div className="w-full h-20 border-b flex px-4 items-center mb-8">
					<p className="font-semibold text-3xl text-green-400 pl-4">Admin</p>
				</div>

				<div className="mb-4 px-4">
					<p className="pl-4 text-sm font-semibold mb-1">MAIN</p>
					<div className="w-full flex items-center text-green-400 h-10 pl-4 bg-gray-200 hover:bg-gray-200 rounded-lg cursor-pointer">
					...
					<div className="w-full flex items-center text-green-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
						<svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
				...
				<div className="mb-4 px-4">
					<p className="pl-4 text-sm font-semibold mb-1">Orders</p>
